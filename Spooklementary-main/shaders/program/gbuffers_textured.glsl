...
// MatrixCraft particle support added
/////////////////////////////////////
...
void main() {
    ...
    if (atlasSize.x < atlasCheck) {
        // MATRIXCRAFT EMISSIVE PARTICLE DETECTION - ADD THIS FIRST!
        ...
        else if (color.b > 1.15 * (color.r + color.g) && color.g > color.r * 1.25 && color.g < 0.425 && color.b > 0.75) { // Water Particle
